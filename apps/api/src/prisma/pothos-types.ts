...
export default interface PrismaTypes {
    ...
    Page: {
        ...
        Create: {};
        Update: {};
        RelationName: "project" | "site" | "mobileApp" | "sections" | "subPages" | "parentPage";
