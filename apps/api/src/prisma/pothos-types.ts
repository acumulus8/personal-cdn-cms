...
export default interface PrismaTypes {
    ...
    Page: {
        ...
        Create: {};
        Update: {};
        RelationName: "project" | "site" | "sections" | "subPages" | "parentPage" | "mobileApp";
