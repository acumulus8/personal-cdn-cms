...
export default interface PrismaTypes {
    ...
    Client: {
        ...
        Create: {};
        Update: {};
        RelationName: "addresses" | "media" | "projects";
        ListRelations: "addresses" | "media" | "projects";
        Relations: {
            addresses: {
                Shape: Address[];
                Name: "Address";
    ...
    Page: {
        ...
        Create: {};
        Update: {};
        RelationName: "project" | "site" | "sections" | "subPages" | "parentPage" | "mobileApps";
        ListRelations: "sections" | "subPages" | "mobileApps";
        Relations: {
            project: {
                Shape: Project;
                Name: "Project";
    ...
    Project: {
        ...
        Create: {};
        Update: {};
        RelationName: "client" | "sites" | "mobileApps" | "apis" | "media" | "pages" | "contents";
        ListRelations: "sites" | "mobileApps" | "apis" | "media" | "pages" | "contents";
        Relations: {
            client: {
                Shape: Client;
                Name: "Client";
